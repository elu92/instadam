# -*- coding: utf-8 -*-
"""
Created on Sat Nov 19 14:15:30 2022
...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.shapeButtons = [ShapeButton(shape, color, self.viewer) for shape, color in
                             zip(self.shapes, self.shapeColors)]
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_BracketRight:
            ...
            QWidgets.keyPressEvent(self, event)
